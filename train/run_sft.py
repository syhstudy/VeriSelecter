...
model, tokenizer = FastLanguageModel.from_pretrained(
    ...
    # model_name = "/home/syh123/workspace/models/Qwen2.5-Coder-7B",
    # model_name = "/home/syh123/workspace/models/CodeLlama-7b-hf",
...
dataset = load_dataset("json", data_files="/home/syh123/workspace/Data_Filter/baseline/temp/filtered_el2n_25.json", split="train")
print("dataset init ...")
...
trainer = SFTTrainer(
    ...
    args = TrainingArguments(
        ...
        num_train_epochs = 1,
        save_strategy="epoch",
        output_dir="/home/syh123/workspace/Data_Filter/lora_model/results_sc8_rtlcoder_el2n_25",
...
print("保存模型...")
model.save_pretrained_merged("/home/syh123/workspace/Data_Filter/save_models/save_model_sc8_rtlcoder_el2n_25", tokenizer, save_method = "merged_16bit",)
print("训练完成！")
