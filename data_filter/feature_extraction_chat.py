...
def parse_args():
    ...
    parser.add_argument("--pt_data_path", type=str, default='/home/syh123/workspace/Data_Filter/data_filter/intermediate_data/cl7/rtlcoder_step1_feature_extract_pre.pt', help='中间数据文件路径')
    parser.add_argument("--model_path", type=str, default='/home/syh123/workspace/Data_Filter/save_models/save_model_cl7_rtlcoder_pre', help='模型路径')
